...
FROM (SELECT jsonb_strip_nulls(jsonb_build_object(
		...
		'thesis_advisor', src->'thesis_advisor',
		'thesis_committee', src->'thesis_committee',
		'thesis_type', src->'thesis_type',
		'thesis_degree', src->'thesis_degree',
		'thesis_degree_grantor', src->'thesis_degree_grantor',
		'thesis_submitted_date', src->'thesis_submitted_date',
